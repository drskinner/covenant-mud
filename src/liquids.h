...
typedef enum
{
  COND_DRUNK, COND_FULL, COND_THIRST, COND_WIRED, MAX_CONDS
} conditions;

typedef enum
{
  LIQTYPE_NORMAL, LIQTYPE_ALCOHOL, LIQTYPE_CAFFEINE, LIQTYPE_POISON, LIQTYPE_SALTY, LIQTYPE_SOLUTION, LIQTYPE_TOP
} liquid_struct_types;
