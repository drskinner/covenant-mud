...
typedef enum
{
  ...
  ATCK_TRIP, ATCK_BASH, ATCK_STUN, ATCK_GOUGE, ATCK_BACKSTAB, ATCK_11,
...
typedef enum
{
  ...
  APPLY_FULL, APPLY_THIRST, APPLY_DRUNK, APPLY_WIRED, APPLY_COOK,
...
typedef enum
{
  ...
  ROOM_NOFLOOR, ROOM_NOGOTO, ROOM_ARENA, ROOM_NOMISSILE, ROOM_NOGOSSIP, ROOM_NOQUIT,
...
char *cap_initial args((const char *str));
...
void obj_from_hex args((OBJ_DATA * obj));
